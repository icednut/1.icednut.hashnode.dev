...
위에 언급한 결과물과 관련 테스트코드는 Github([https://github.com/icednut/kotlin-springtx-exercise/tree/step-02](https://github.com/icednut/kotlin-springtx-exercise/tree/step-02))에 정리해 두었다. 실제로 로컬환경에서 실행도 가능하다.
